...
public abstract class GA {
    ...
    /**最大迭代次数*/
    private int maxIterNum = 150; 
    /**基因变异的概率*/
    private double mutationRate = 0.001;
    /**最大变异步长*/
    private int maxMutationNum = 3;  
    /**当前遗传到第几代*/  
    public int[] geneRecord=new int[excelData.keyInit().length];
    ...
    public void print() {  
        ...
        for(int i=0;i<geneRecord.length;i++)
        {
            System.out.print(excelData.excelData[0][geneRecord[i]]+" ");
        }
        System.out.print(excelData.excelData[0][geneRecord[0]]+" ");
