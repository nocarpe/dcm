...
public class LocalDateUtils {
    ...
    public static String[] dataStringFormats = {F8, F10, F14, F19, "yyyy/MM/dd", "yyyy/MM/dd HH:mm",
    ...
    private static Calendar getCalendar(String day) {
        ...
        cal.set(Integer.parseInt(day.substring(0, 4)), Integer.parseInt(day.substring(5, 7)) - 1,
            Integer.parseInt(day.substring(8, 10)), 0, 0, 0);
        return cal;
    }
    ...
    public static String intToDay(long day) {
        ...
        return new StringBuilder().append(dayStr.substring(0, 4)).append("-").append(dayStr.substring(4, 6)).append("-")
            .append(dayStr.substring(6, 8)).toString();
    }
